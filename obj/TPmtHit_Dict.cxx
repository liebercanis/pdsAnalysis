...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::TPmtHit*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("TPmtHit", ::TPmtHit::Class_Version(), "TPmtHit.hxx", 19,
   ...
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_(Init) = GenerateInitInstanceLocal((const ::TPmtHit*)0x0); R__UseDummy(_R__UNIQUE_(Init));
...
{
   if (!fgIsA.load()) { R__LOCKGUARD2(gInterpreterMutex); fgIsA = ::ROOT::GenerateInitInstanceLocal((const ::TPmtHit*)0x0)->GetClass(); }
   return fgIsA;
}
